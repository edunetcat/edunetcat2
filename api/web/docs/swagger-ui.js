...
this["Handlebars"]["templates"]["operation"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "          <div style='margin:0;padding:0;display:inline'></div>\n          <h4>Missatges de resposta</h4>\n          <table class='fullwidth'>\n            <thead>\n            <tr>\n              <th>Codi HTTP</th>\n              <th>Descripci&oacute;</th>\n              <th>Model de resposta</th>\n            </tr>\n            </thead>\n            <tbody class=\"operation-status\">\n            \n            </tbody>\n          </table>\n";
  },"22":function(depth0,helpers,partials,data) {
  return "";
},"24":function(depth0,helpers,partials,data) {
  return "          <div class='sandbox_header'>\n            <input class='submit' name='commit' type='button' value='Provar consulta!' />\n            <a href='#' class='response_hider' style='display:none'>Amagar Resposta</a>\n            <span class='response_throbber' style='display:none'></span>\n          </div>\n";
  },"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  if (stack1 != null) { buffer += stack1; }
  return buffer + "        </form>\n        <div class='response' style='display:none'>\n          <h4>URL de consulta</h4>\n          <div class='block request_url'></div>\n          <h4>Resposta</h4>\n          <div class='block response_body'></div>\n          <h4>Codi de Resposta</h4>\n          <div class='block response_code'></div>\n          <h4>Cap&ccedil;alera de resposta</h4>\n          <div class='block response_headers'></div>\n        </div>\n      </div>\n    </li>\n  </ul>\n";
},"useData":true});
var ContentTypeView,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  __hasProp = {}.hasOwnProperty;
